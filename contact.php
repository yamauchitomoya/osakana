...
$site_top = "http://aoimorivege.com/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@aoimorivege.com";
...
$Referer_check_domain = "http://aoimorivege.com/";
...
$thanksPage = "http://aoimorivege.com/";
...
<?php echo $errm; ?><br /><br /><input type="button" class="btn btn-secondary mt-3" value=" 前画面に戻る " onClick="history.back()">
</div>
<?php }else{ ?>
<h3>確認画面</h3>
<p align="center">「送信する」ボタンを押してください。</p>
...
<input type="submit" class="btn btn-primary mt-3" value="　送信する　">
<input type="button" class="btn btn-secondary mt-3" value="前画面に戻る" onClick="history.back()"></p>
</form>
<?php } ?>
</div><!-- /formWrap -->
</div>
...
<br /><br /><input type="button" class="btn btn-secondary mt-3" value=" 前画面に戻る " onClick="history.back()">
</div>
</body>
</html>
<?php }else{ ?>
...
//確認画面無しの場合の表示、指定のページに移動する設定の場合、エラーチェックで問題が無ければ指定ページヘリダイレクト
	...
	if($empty_flag == 1){ ?>
<div align="center"><h4>入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4><div style="color:red"><?php echo $errm; ?></div><br /><br /><input type="button" class="btn btn-secondary mt-3" value=" 前画面に戻る " onClick="history.back()"></div>
<?php 
...
function copyright(){
	echo '<p class="text-center">- 株式会社 青い郷里 -</p>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
